...
/*!**************************************!*\
  !*** ./src/js/constants/elements.js ***!
  \**************************************/
/*! exports provided: SOURCES_OUTERS, SOURCES_INNERS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"SOURCES_OUTERS\", function() { return SOURCES_OUTERS; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"SOURCES_INNERS\", function() { return SOURCES_INNERS; });\nvar sourcesBaseName = 'sources';\nvar SOURCES_OUTERS = sourcesBaseName + 'Outers';\nvar SOURCES_INNERS = sourcesBaseName + 'Inners';\n\n//# sourceURL=webpack:///./src/js/constants/elements.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"setUpSlideIndexChanger\", function() { return setUpSlideIndexChanger; });\n/* harmony import */ var _constants_css_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../constants/css-constants */ \"./src/js/constants/css-constants.js\");\n/* harmony import */ var _constants_elements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../constants/elements */ \"./src/js/constants/elements.js\");\n/* harmony import */ var _constants_classes_names__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../constants/classes-names */ \"./src/js/constants/classes-names.js\");\n/* harmony import */ var _helpers_elements_removeFromElementClassIfContains__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../helpers/elements/removeFromElementClassIfContains */ \"./src/js/helpers/elements/removeFromElementClassIfContains.js\");\n/* harmony import */ var _timeouts_getQueuedAction__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../timeouts/getQueuedAction */ \"./src/js/core/timeouts/getQueuedAction.js\");\n\n\n\n\n\nfunction setUpSlideIndexChanger(_ref) {\n  var sourcesOutersTransformers = _ref.collections.sourcesOutersTransformers,\n      componentsServices = _ref.componentsServices,\n      _ref$core = _ref.core,\n      classFacade = _ref$core.classFacade,\n      self = _ref$core.slideIndexChanger,\n      sourceDisplayFacade = _ref$core.sourceDisplayFacade,\n      stageManager = _ref$core.stageManager,\n      sourcesInners = _ref.elements.sourcesInners,\n      stageIndexes = _ref.stageIndexes;\n  var runQueuedRemoveFadeOut = Object(_timeouts_getQueuedAction__WEBPACK_IMPORTED_MODULE_4__[\"getQueuedAction\"])(function () {\n    classFacade.removeFromEachElementClassIfContains(_constants_elements__WEBPACK_IMPORTED_MODULE_1__[\"SOURCES_INNERS\"], _constants_classes_names__WEBPACK_IMPORTED_MODULE_2__[\"FADE_OUT_CLASS_NAME\"]);\n  }, _constants_css_constants__WEBPACK_IMPORTED_MODULE_0__[\"ANIMATION_TIME\"]);\n\n  self.changeTo = function (i) {\n    stageIndexes.current = i;\n    stageManager.updateStageIndexes();\n    componentsServices.setSlideNumber(i + 1);\n    sourceDisplayFacade.displayStageSourcesIfNotYet();\n  };\n\n  self.jumpTo = function (i) {\n    var previousI = stageIndexes.current;\n    self.changeTo(i);\n    classFacade.removeFromEachElementClassIfContains(_constants_elements__WEBPACK_IMPORTED_MODULE_1__[\"SOURCES_OUTERS\"], _constants_classes_names__WEBPACK_IMPORTED_MODULE_2__[\"TRANSFORM_TRANSITION_CLASS_NAME\"]);\n    Object(_helpers_elements_removeFromElementClassIfContains__WEBPACK_IMPORTED_MODULE_3__[\"removeFromElementClassIfContains\"])(sourcesInners[previousI], _constants_classes_names__WEBPACK_IMPORTED_MODULE_2__[\"FADE_IN_STRONG_CLASS_NAME\"]);\n    Object(_helpers_elements_removeFromElementClassIfContains__WEBPACK_IMPORTED_MODULE_3__[\"removeFromElementClassIfContains\"])(sourcesInners[previousI], _constants_classes_names__WEBPACK_IMPORTED_MODULE_2__[\"FADE_IN_CLASS_NAME\"]);\n    sourcesInners[previousI].classList.add(_constants_classes_names__WEBPACK_IMPORTED_MODULE_2__[\"FADE_OUT_CLASS_NAME\"]);\n    Object(_helpers_elements_removeFromElementClassIfContains__WEBPACK_IMPORTED_MODULE_3__[\"removeFromElementClassIfContains\"])(sourcesInners[i], _constants_classes_names__WEBPACK_IMPORTED_MODULE_2__[\"FADE_IN_STRONG_CLASS_NAME\"]);\n    Object(_helpers_elements_removeFromElementClassIfContains__WEBPACK_IMPORTED_MODULE_3__[\"removeFromElementClassIfContains\"])(sourcesInners[i], _constants_classes_names__WEBPACK_IMPORTED_MODULE_2__[\"FADE_OUT_CLASS_NAME\"]);\n    sourcesInners[i].classList.add(_constants_classes_names__WEBPACK_IMPORTED_MODULE_2__[\"FADE_IN_CLASS_NAME\"]); // we need to remove fade out from all sources because if someone used slide swiping during animation timeout\n    // we cannot detect what slide will be\n\n    runQueuedRemoveFadeOut();\n    sourcesOutersTransformers[i].zero();\n    setTimeout(function () {\n      if (previousI !== stageIndexes.current) {\n        sourcesOutersTransformers[previousI].negative();\n      }\n    }, _constants_css_constants__WEBPACK_IMPORTED_MODULE_0__[\"ANIMATION_TIME\"] - 30);\n  };\n}\n\n//# sourceURL=webpack:///./src/js/core/slide/setUpSlideIndexChanger.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"styles\", function() { return styles; });\nvar styles = \".fslightbox-absoluted{position:absolute;top:0;left:0}.fslightbox-fade-in{animation:fslightbox-fade-in .25s cubic-bezier(0,0,.7,1)}.fslightbox-fade-out{animation:fslightbox-fade-out .25s ease}.fslightbox-fade-in-strong{animation:fslightbox-fade-in-strong .25s cubic-bezier(0,0,.7,1)}.fslightbox-fade-out-strong{animation:fslightbox-fade-out-strong .25s ease}@keyframes fslightbox-fade-in{from{opacity:.65}to{opacity:1}}@keyframes fslightbox-fade-out{from{opacity:.35}to{opacity:0}}@keyframes fslightbox-fade-in-strong{from{opacity:.3}to{opacity:1}}@keyframes fslightbox-fade-out-strong{from{opacity:1}to{opacity:0}}.fslightbox-cursor-grabbing{cursor:grabbing}.fslightbox-full-dimension{width:100%;height:100%}.fslightbox-open{overflow:hidden;height:100%}.fslightbox-flex-centered{display:flex;justify-content:center;align-items:center}.fslightbox-hidden{display:none}.fslightbox-opacity-0{opacity:0!important}.fslightbox-opacity-1{opacity:1!important}.fslightbox-scrollbarfix{padding-right:17px}.fslightbox-transform-transition{transition:transform .3s}.fslightbox-container{font-family:sans-serif;position:fixed;top:0;left:0;background:linear-gradient(rgba(255,255,255,.91),#fff 1810%);z-index:9999999;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;-webkit-tap-highlight-color:transparent}.fslightbox-container *{box-sizing:border-box}.fslightbox-svg-path{transition:fill .15s ease;fill:#fff}.fslightbox-nav{height:45px;width:100%;position:absolute;top:0;left:0}.fslightbox-slide-number-container{height:100%;font-size:14px;color:#fff;z-index:0;max-width:55px;background:rgba(210,58,50,.9)}.fslightbox-slide-number-container div{padding:0 1.5px}.fslightbox-slash{margin-top:-1.5px;font-size:16px}.fslightbox-toolbar{position:absolute;z-index:3;right:0;top:0;height:100%;display:flex;background:rgba(210,58,50,.9)}.fslightbox-toolbar-button{height:100%;width:45px;cursor:pointer}.fslightbox-toolbar-button:hover .fslightbox-svg-path{fill:#fff}.fslightbox-slide-btn-container{display:flex;align-items:center;padding:12px 12px 12px 6px;position:absolute;top:50%;cursor:pointer;z-index:3;transform:translateY(-50%)}@media (min-width:476px){.fslightbox-slide-btn-container{padding:22px 22px 22px 6px}}@media (min-width:768px){.fslightbox-slide-btn-container{padding:30px 30px 30px 6px}}.fslightbox-slide-btn-container:hover .fslightbox-svg-path{fill:#f1f1f1}.fslightbox-slide-btn{padding:9px;font-size:26px;background:rgba(210,58,50,.9)}@media (min-width:768px){.fslightbox-slide-btn{padding:10px}}@media (min-width:1600px){.fslightbox-slide-btn{padding:11px}}.fslightbox-slide-btn-container-previous{left:0}@media (max-width:475.99px){.fslightbox-slide-btn-container-previous{padding-left:3px}}.fslightbox-slide-btn-container-next{right:0;padding-left:12px;padding-right:3px}@media (min-width:476px){.fslightbox-slide-btn-container-next{padding-left:22px}}@media (min-width:768px){.fslightbox-slide-btn-container-next{padding-left:30px}}@media (min-width:476px){.fslightbox-slide-btn-container-next{padding-right:6px}}.fslightbox-down-event-detector{position:absolute;z-index:1}.fslightbox-slide-swiping-hoverer{z-index:4}.fslightbox-invalid-file-wrapper{font-size:22px;color:#eaebeb;margin:auto}.fslightbox-video{object-fit:cover}.fslightbox-youtube-iframe{border:0}.fslightbox-loader{display:block;margin:auto;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:67px;height:67px}.fslightbox-loader div{box-sizing:border-box;display:block;position:absolute;width:54px;height:54px;margin:6px;border:5px solid;border-color:#999 transparent transparent transparent;border-radius:50%;animation:fslightbox-loader 1.2s cubic-bezier(.5,0,.5,1) infinite}.fslightbox-loader div:nth-child(1){animation-delay:-.45s}.fslightbox-loader div:nth-child(2){animation-delay:-.3s}.fslightbox-loader div:nth-child(3){animation-delay:-.15s}@keyframes fslightbox-loader{0%{transform:rotate(0)}100%{transform:rotate(360deg)}}.fslightbox-source{position:relative;margin:auto;opacity:0;z-index:2;backface-visibility:hidden;transform:translateZ(0);transition:opacity .3s;will-change:opacity}.fslightbox-source-outer{will-change:transform}\";\n\n//# sourceURL=webpack:///./src/js/core/styles/styles.js?");
